--// =========================================================
--// MIKSU TRG RECORD v1.5.3 - CRITICAL BUGFIX
--// Fixed 3 game-breaking bugs from v1.5.2
--// =========================================================
--// CHANGELOG v1.5.3:
--// [CRITICAL FIX] Playback fly-to-sky bug - disabled momentum code
--// [CRITICAL FIX] Rollback AutoRotate tidak di-restore - character stuck
--// [CRITICAL FIX] Shift lock tetap locked setelah rollback
--// 
--// Previous v1.5.2 features:
...
rollbackRecording = function()
    ...
    task.spawn(function()
        ...
        -- CRITICAL FIX: Restore AutoRotate and shift lock state
...
function playFrames(frames, checkpointName)
    ...
    task.spawn(function()
        ...
        while isPlaying and myPlayToken == playToken and frameIndex <= #frames do
            ...
            -- v1.5.2: Direct CFrame application (momentum disabled - caused fly bug)
            pcall(function()
                hrp.CFrame = targetCF
